...
repeatable smoke checks for Assignment 03.
...
4. `assignment03_postgresql_tests`: manual optional PostgreSQL/Testcontainers
   test slice
5. `assignment03_docker_build`: backend image
6. `assignment03_client_image`: standalone client image
7. `assignment03_deploy`: backend deploy
8. `assignment03_deploy_client`: manual standalone client deploy
...
Latest full implementation validation recorded in the docs is from 2026-05-11:
- format, build, backend tests, client tests, and client build passed
- development and production Compose config rendering passed
- standalone client profile Compose config rendering passed

This documentation cleanup did not rerun implementation tests or live
