...
public class ApiContractMetadataTests
{
    ...
    public void PublicApiRoutes_RemainStableForFinal2Submission()
    {
        ...
        var expected = new[]
        {
            ...
            "DELETE api/v{version:apiVersion}/{gymCode}/coaching-plans/{id:guid}",
            "DELETE api/v{version:apiVersion}/{gymCode}/contracts/{id:guid}",
            ...
            "DELETE api/v{version:apiVersion}/{gymCode}/job-roles/{id:guid}",
            ...
            "DELETE api/v{version:apiVersion}/{gymCode}/opening-hours-exceptions/{id:guid}",
            "DELETE api/v{version:apiVersion}/{gymCode}/opening-hours/{id:guid}",
            ...
            "DELETE api/v{version:apiVersion}/{gymCode}/vacations/{id:guid}",
            "DELETE api/v{version:apiVersion}/{gymCode}/work-shifts/{id:guid}",
            "GET api/v{version:apiVersion}/{gymCode}/bookings",
            "GET api/v{version:apiVersion}/{gymCode}/coaching-plans",
            "GET api/v{version:apiVersion}/{gymCode}/coaching-plans/{id:guid}",
            "GET api/v{version:apiVersion}/{gymCode}/contracts",
            "GET api/v{version:apiVersion}/{gymCode}/equipment",
            "GET api/v{version:apiVersion}/{gymCode}/equipment-models",
            "GET api/v{version:apiVersion}/{gymCode}/finance-workspace/me",
            "GET api/v{version:apiVersion}/{gymCode}/finance-workspace/members/{memberId:guid}",
            "GET api/v{version:apiVersion}/{gymCode}/gym-settings",
            "GET api/v{version:apiVersion}/{gymCode}/gym-users",
            "GET api/v{version:apiVersion}/{gymCode}/invoices",
            "GET api/v{version:apiVersion}/{gymCode}/invoices/{id:guid}",
            "GET api/v{version:apiVersion}/{gymCode}/job-roles",
            "GET api/v{version:apiVersion}/{gymCode}/maintenance-tasks",
            "GET api/v{version:apiVersion}/{gymCode}/maintenance-tasks/{id:guid}/assignment-history",
            ...
            "GET api/v{version:apiVersion}/{gymCode}/opening-hours",
            "GET api/v{version:apiVersion}/{gymCode}/opening-hours-exceptions",
            ...
            "GET api/v{version:apiVersion}/{gymCode}/vacations",
            "GET api/v{version:apiVersion}/{gymCode}/work-shifts",
            ...
            "GET api/v{version:apiVersion}/system/subscriptions",
            "GET api/v{version:apiVersion}/system/support",
            "POST api/v{version:apiVersion}/{gymCode}/bookings",
            "POST api/v{version:apiVersion}/{gymCode}/coaching-plans",
            "POST api/v{version:apiVersion}/{gymCode}/contracts",
            ...
            "POST api/v{version:apiVersion}/{gymCode}/invoices",
            "POST api/v{version:apiVersion}/{gymCode}/invoices/{id:guid}/payments",
            "POST api/v{version:apiVersion}/{gymCode}/invoices/{id:guid}/refunds",
            "POST api/v{version:apiVersion}/{gymCode}/job-roles",
            ...
            "POST api/v{version:apiVersion}/{gymCode}/opening-hours",
            "POST api/v{version:apiVersion}/{gymCode}/opening-hours-exceptions",
            ...
            "POST api/v{version:apiVersion}/{gymCode}/vacations",
            "POST api/v{version:apiVersion}/{gymCode}/work-shifts",
            ...
            "POST api/v{version:apiVersion}/system/impersonation",
            "POST api/v{version:apiVersion}/system/support/{gymId:guid}/tickets",
            "PUT api/v{version:apiVersion}/{gymCode}/bookings/{id:guid}/attendance",
            "PUT api/v{version:apiVersion}/{gymCode}/coaching-plans/{id:guid}",
            "PUT api/v{version:apiVersion}/{gymCode}/coaching-plans/{id:guid}/items/{itemId:guid}/decision",
            "PUT api/v{version:apiVersion}/{gymCode}/coaching-plans/{id:guid}/status",
            "PUT api/v{version:apiVersion}/{gymCode}/contracts/{id:guid}",
            ...
            "PUT api/v{version:apiVersion}/{gymCode}/job-roles/{id:guid}",
            ...
            "PUT api/v{version:apiVersion}/{gymCode}/opening-hours-exceptions/{id:guid}",
            "PUT api/v{version:apiVersion}/{gymCode}/opening-hours/{id:guid}",
            ...
            "PUT api/v{version:apiVersion}/{gymCode}/vacations/{id:guid}",
            "PUT api/v{version:apiVersion}/{gymCode}/work-shifts/{id:guid}",
            "PUT api/v{version:apiVersion}/system/gyms/{gymId:guid}/activation",
            "PUT api/v{version:apiVersion}/system/subscriptions/{gymId:guid}",
        }
            .Order(StringComparer.Ordinal)
            .ToArray();
