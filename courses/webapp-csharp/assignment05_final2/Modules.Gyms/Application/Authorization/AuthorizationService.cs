    ...
    IResourceAuthorizationChecker resourceAuthorizationChecker) : IAuthorizationService
{
    ...
    public Task EnsureBookingAccessAsync(Guid gymId, Guid memberId, Guid trainingSessionId, CancellationToken cancellationToken = default)
    {
        return resourceAuthorizationChecker.EnsureBookingAccessAsync(gymId, memberId, trainingSessionId, cancellationToken);
    }
