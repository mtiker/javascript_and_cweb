...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    loginEyebrow: "Final2 SaaS client",
  ...
  "et-EE": {
    ...
    loginEyebrow: "Final2 SaaS klient",
    ...
    switchRole: "Vaheta aktiivset rolli",
    ...
    "Schedule": "Ajastamine",
    "New training session": "Uus treening",
    "Category": "Kategooria",
    "Starts": "Algab",
    "Ends": "Lõpeb",
    "Published": "Avaldatud",
    "Draft": "Mustand",
    "Scheduling...": "Ajastan...",
    "Schedule session": "Ajasta treening",
    "Create a category before scheduling sessions.": "Loo enne treeningute ajastamist kategooria.",
    ...
    "Status": "Staatus",
    "Notes": "Märkmed",
    "New maintenance task": "Uus hooldustöö",
    "Equipment": "Varustus",
    ...
    "Critical": "Kriitiline",
    "Due": "Tähtaeg",
    "Schedule maintenance": "Ajasta hooldus",
    "Add equipment before scheduling maintenance.": "Lisa enne hoolduse ajastamist varustus.",
