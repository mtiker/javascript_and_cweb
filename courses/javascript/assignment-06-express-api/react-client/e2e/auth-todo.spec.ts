 ...
 *
 * The A06 Express backend URL is baked into the client bundle at build time.
 * We intercept those calls with page.route() so the test runs without network
 * access and produces deterministic responses.
 */

const API = "https://mtiker-js-express.proxy.itcollege.ee/api/v1";
